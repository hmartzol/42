...
/*   Updated: 2016/01/06 19:17:12 by hmartzol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define READBUFF 80
# define RETMSG(b, s, r) if (b) {ft_putstr(s); return (r);}
# define SMALLOC(o, t, s, r) if (!(o = (t*)malloc(s * sizeof(t)))) return (r)
...
void				ft_alstitter(t_alist *lst, void (*f)(t_alist *elem));
